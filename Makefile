...
# Include files
INC_PRE := webserv.hpp Server.hpp Client.hpp ServerConfig.hpp ConfigFile.hpp
INC_DIR := include/
INC		:= $(addprefix $(INC_DIR), $(INC_PRE))

# Source files
SRC_PRE	:= main.cpp webserv.cpp Server.cpp Client.cpp ServerConfig.cpp ConfigFile.cpp
SRC_DIR	:= src/
